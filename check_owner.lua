...
-- see http://forum.minetest.net/viewtopic.php?pid=26061
-- or https://github.com/VanessaE/homedecor for details!
function replacer_homedecor_node_is_owned(pos, placer)
	...
	if ownername ~= false then
		minetest.chat_send_player(placer:get_player_name(), "Sorry, "..
			ownername.." owns that spot.")
		return true
	else
		return false
	end
